...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/SAFE-anwang/EvmKit.Swift.git", .upToNextMajor(from: "2.0.15")),
        .package(url: "https://github.com/SAFE-anwang/Eip20Kit.Swift.git", .upToNextMajor(from: "2.0.3")),
